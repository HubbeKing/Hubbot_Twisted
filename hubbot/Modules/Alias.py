    ...
    def on_trigger(self, message):
        ...
        if message.command in self.triggers:
            if message.command == "alias":
                ...
                return IRCResponse(ResponseType.SAY, "Created a new alias '{}' for '{}'.".format(message.parameter_list[0].lower(), " ".join(message.parameter_list[1:])), message.reply_to)
                ...
                if message.parameter_list[0].lower() in self.aliases:
                    ...
                    return IRCResponse(ResponseType.SAY, "Deleted alias '{}'".format(message.parameter_list[0].lower()), message.reply_to)
                else:
                    return IRCResponse(ResponseType.SAY, "I don't have an alias '{}'".format(message.parameter_list[0].lower()), message.reply_to)
                ...
                if len(message.parameter_list) == 0:
                    ...
                    return IRCResponse(ResponseType.SAY, "{} is an alias for: {}".format(message.parameter_list[0].lower(), " ".join(self.aliases[message.parameter_list[0].lower()])), message.reply_to)
                else:
                    return IRCResponse(ResponseType.SAY, "'{}' does not match any known alias!".format(message.parameter_list[0].lower()), message.reply_to)
                ...
                if message.parameter_list[0].lower() not in self.aliases:
                    return IRCResponse(ResponseType.SAY, "I have no alias called {!r}.".format(message.parameter_list[0].lower()), message.reply_to)
                if len(message.parameter_list) == 1:
                    return IRCResponse(ResponseType.SAY, "You didn't give me any help text to set for {!r}!".format(message.parameter_list[0].lower()), message.reply_to)
                ...
                with sqlite3.connect(self.bot.database_file) as conn:
                    ...
                    conn.commit()
                return IRCResponse(ResponseType.SAY, "{!r} help text set to {!r}.".format(alias, alias_help), message.reply_to)
