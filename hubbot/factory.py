...
class HubbotFactory(protocol.ReconnectingClientFactory):
    ...
    def startedConnecting(self, connector):
        ...
        """
        self.bot.logger.info("-#- Started to connect to \"{}\".".format(connector.getDestination()))
    ...
    def clientConnectionLost(self, connector, reason):
        ...
        if not self.bot.Quitting:
            self.bot.logger.warning("-!- Connection to \"{}\" lost, reason: \"{}\" Retrying in {} seconds.".format(connector.getDestination(), reason.getErrorMessage(), self.delay))
    ...
    def clientConnectionFailed(self, connector, reason):
        ...
        @type reason: twisted.python.failure.Failure
        """
        self.bot.logger.warning("-!- Connection to \"{}\" failed, reason: \"{}\" Retrying in {} seconds.".format(connector.getDestination(), reason.getErrorMessage(), self.delay))
