...
class Instantiate(Function):
    Help = "donotwant, yes, yup, store, goat, stupid, fixyou, heya, HNGH, PS, whoa, what, mybrand, both, no, disappoint -- Used to post silly things! Usage: {}<thing>".format(
        GlobalVars.CommandChar)
    seconds = 300
    ...
    def GetResponse(self, HubbeBot, message):
        ...
        if message.Command == "nope":
            ...
            return IRCResponse(ResponseType.Say, "http://24.media.tumblr.com/tumblr_malzltlKk21rggqwfo1_500.gif",
                               message.ReplyTo)

        elif message.Command == "ps" or message.Command == "psc":
            return IRCResponse(ResponseType.Say,
                               "https://docs.google.com/document/d/1C4Maba3fXrLYMMIXK67OOn7C2c31V6nff5inGAZStsw/edit?pli=1",
                               message.ReplyTo)
            ...
            if message.User.Name in GlobalVars.admins:
                ...
                return IRCResponse(ResponseType.Say, line1, message.ReplyTo), IRCResponse(ResponseType.Say, line2,
                                                                                          message.ReplyTo), IRCResponse(
                    ResponseType.Say, line3, message.ReplyTo), IRCResponse(ResponseType.Say, line4, message.ReplyTo)
            ...
            return IRCResponse(ResponseType.Say,
                               "https://31.media.tumblr.com/cea6574a24b490ada8bec694e87b307b/tumblr_n3blu9k5CW1tsipf6o6_400.gif",
                               message.ReplyTo)
